    ...
    >
      <m.div variants={varFade().inDown}>
        ...
        <Typography variant="body1" sx={{ fontSize: '1.2rem', color: 'text.secondary', mb: 3 }}>
          Our TEK Aid Partners are organizations that share our values and believe in the power of
          education. Through these partnerships, we&apos;re able to offer additional financial aid
          options to our students. From scholarships to discounts, these organizations have a
          variety of aid programs that may be a good fit for you.
        </Typography>
      </m.div>
