    ...
    >
      <m.div variants={varFade().inDown}>
        ...
        <Typography variant="body1" sx={{ fontSize: '1.2rem', color: 'text.secondary', mb: 3 }}>
          At Tek School, we&apos;re committed to making education accessible and affordable. Contact
          us today to learn more about our TEK Aid Partners and how we can help you reach your
          educational goals.
        </Typography>
      </m.div>
