    ...
    >
      <m.div variants={varFade().inDown}>
        ...
        <Typography variant="body1" sx={{ fontSize: '1.2rem', color: 'text.secondary', mb: 3 }}>
          Our students come from diverse backgrounds, but they all share an ambition for growth, and
          the grit that makes a success Tek School student. Learn about our students&apos; great
          success stories!
        </Typography>
      </m.div>
