    ...
    >
      <m.div variants={varFade().inDown}>
        ...
        <Typography variant="body1" sx={{ fontSize: '1.2rem', color: 'text.secondary', mb: 3 }}>
          We are excited to schedule your visit! Meet with our staff and instructors, get a feel for
          our classrooms and learning environment, and ask any questions you may have about our
          programs!
        </Typography>
      </m.div>
