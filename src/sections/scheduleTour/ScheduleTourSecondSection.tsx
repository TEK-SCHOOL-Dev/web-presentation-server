  ...
  return (
    ...
    >
      <m.div variants={varFade().inLeft}>
        ...
        >
          <span>Fill</span> out the form below with your preferred date and time. Our team will be
          in touch to confirm your appointment and provide you with any additional information you
          may need. [Consider a Calendly scheduler or something automated.]
        </Typography>
      </m.div>
