    ...
    >
      <m.div variants={varFade().inDown}>
        ...
        <Typography variant="body1" sx={{ fontSize: '1.2rem', color: 'text.secondary', mb: 3 }}>
          We understand that every student is unique, and we strive to work with each individual to
          ensure they successfully complete our programs. Our admissions team is here to help you
          every step of the way! Reach out!
        </Typography>
      </m.div>
