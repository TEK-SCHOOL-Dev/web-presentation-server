  ...
  return (
    ...
    >
      <m.div variants={varFade().inLeft}>
        ...
        >
          <span>While</span> some programs may require background in math and science, most courses
          require a high school diploma or equivalent, basic computer skills, and a strong desire to
          learn.
        </Typography>
      </m.div>
