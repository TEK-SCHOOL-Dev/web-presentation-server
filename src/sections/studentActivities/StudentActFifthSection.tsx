  ...
  return (
    ...
    >
      <m.div variants={varFade().inDown}>
        ...
        >
          [Month, Year] Bowling Night for Panthers Class Gathering
        </Typography> */}
        <Typography
          variant="body1"
          sx={{
        ...
        >
          <span> We&apos;re </span> always looking for new ways to bring our students together. At
          Tek School, a strong student community is key to lasting relations, learning and success.
          Ask your instructor about upcoming events and activities!
        </Typography>
      </m.div>
