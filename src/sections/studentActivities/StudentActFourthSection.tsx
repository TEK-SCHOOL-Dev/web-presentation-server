  ...
  return (
    ...
    >
      <m.div variants={varFade().inLeft}>
        ...
        >
          Hiking and Picnic at Yosemite National Park
        </Typography>
        <Typography
          variant="body1"
          sx={{
        ...
        >
          <span> At </span> Yosemite National Park, scenic hikes and picnic lunch helped our
          students to relax and unwind while connecting with nature and each other.
        </Typography>
      </m.div>
