  ...
  return (
    <Stack spacing={3} sx={{ mb: 10, textAlign: 'center' }}>
      ...
      <m.div variants={varFade().inDown}>
        <Typography variant="h2">Admission Requirements</Typography>
      </m.div>

      <m.div variants={varFade().inDown}>
        <Typography sx={{ color: 'text.secondary' }}>
          Learn about the prerequisites and admission requirements for our SDET program, ensuring
          you have the qualifications and background for a successful experience.
        </Typography>
        <Typography sx={{ color: 'text.secondary' }}>
          To join our comprehensive SDET program at TEK School, applicants must meet specific
          requirements and undergo a detailed admission process. Here&apos;s an overview of the
        ...
        >
          <m.div variants={varFade().inDown}>
            <Typography sx={{ mt: 2, mb: 5, color: 'text.secondary' }}>
              By meeting these requirements and following the enrollment process, you&apos;ll be
              well on your way to a successful career in the software testing industry.
            </Typography>
          </m.div>
