    ...
    >
      <m.div variants={varFade().inDown}>
        ...
        <Typography variant="body1" sx={{ fontSize: '1.2rem', color: 'text.secondary', mb: 3 }}>
          We are a diverse group of social entrepreneurs, educators, and technology experts who
          share a common goal of creating an inclusive, innovative and empowering learning
          community.
        </Typography>
      </m.div>
