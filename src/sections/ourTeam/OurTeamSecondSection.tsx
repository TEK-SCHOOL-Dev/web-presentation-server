  ...
  return (
    ...
    >
      <m.div variants={varFade().inLeft}>
        ...
        >
          <span>Providing</span> institutional resources and individualized coaching to our
          students, we strive for a welcoming and inclusive environment that encourages
