    ...
    >
      <m.div variants={varFade().inDown}>
        ...
        <Typography variant="body1" sx={{ fontSize: '1.2rem', color: 'text.secondary', mb: 3 }}>
          Stay up-to-date about the latest developments in information technology. Tek School offers
          a range of short webinars and workshops, designed to give you a taste of the most exciting
