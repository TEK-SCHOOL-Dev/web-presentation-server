  ...
  return (
    ...
    >
      <m.div variants={varFade().inLeft}>
        ...
        >
          <span>To</span> apply for Tek School financial aid, students should carefully review the
          options available for their specific training program. Such information is usually
          discussed during our information sessions.
        </Typography>
      </m.div>
