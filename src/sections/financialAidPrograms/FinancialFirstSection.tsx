    ...
    >
      <m.div variants={varFade().inDown}>
        ...
        <Typography variant="body1" sx={{ fontSize: '1.2rem', color: 'text.secondary', mb: 3 }}>
          Quality education should be accessible to everyone, regardless of their financial
          situation. As a social enterprise, we offer discounts, scholarships, and grants to help
          applicants join Tek School. Our limited resources are available on a case by case basis.
        </Typography>
      </m.div>
