      ...
      >
        ...
        >
          ...
          <Typography variant="h5" sx={{ mb: 3, lineHeight: 1.5 }}>
            We are committed to providing quality education and helping you achieve your career
            goals.
          </Typography>
          <Typography variant="h5" sx={{ lineHeight: 1.5 }}>
            Check out our media coverage page to see how TEK School is making an impact in the tech
            industry.
          </Typography>
        </Stack>
      </Box>
