    ...
    >
      <m.div variants={varFade().inDown}>
        ...
        <Typography variant="body1" sx={{ fontSize: '1.2rem', color: 'text.secondary', mb: 3 }}>
          Tek School&apos;s strong student community makes collaborative learning possible. Connect
          with fellow students, instructors, and industry professionals from around the world. Our
          forums provide a space for sharing insights and expanding your network in the world of
