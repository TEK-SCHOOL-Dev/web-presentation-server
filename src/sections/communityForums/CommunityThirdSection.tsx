    ...
    >
      <m.div variants={varFade().inDown}>
        ...
        <Typography variant="body1" sx={{ fontSize: '1.2rem', color: 'text.secondary', mb: 3 }}>
          Join a conversation, start a thread, or simply browse through the wealth of available
          information. Our forums are moderated by experienced professionals to ensure a safe and
          respectful environment for all participants. Join our vibrant and supportive learning
          community!
        </Typography>
      </m.div>
