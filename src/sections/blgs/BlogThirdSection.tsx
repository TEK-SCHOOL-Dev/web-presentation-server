    ...
    >
      <m.div variants={varFade().inDown}>
        ...
        <Typography variant="body1" sx={{ fontSize: '1.2rem', color: 'text.secondary', mb: 3 }}>
          Whether you&apos;re looking for tips on how to land your dream tech job, insights on the
          future of AI, or simply want to stay updated on the latest programming practices, our
          blogs have something of interest to you.
        </Typography>
      </m.div>
