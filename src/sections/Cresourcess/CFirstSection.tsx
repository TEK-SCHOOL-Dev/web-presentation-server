  ...
  return (
    ...
    >
      <m.div variants={varFade().inDown}>
        ...
        >
          Looking to start a career in tech? Let us help!
        </Typography>
        <Typography variant="body1" sx={{ fontSize: '1.2rem', color: 'text.secondary', mb: 3 }}>
          Our Career Resources include a wide range of services designed to help you find your dream
          job. From resume reviews and interview coaching to job search strategies and networking
          events, we have everything you need to take your career to the next level.
        </Typography>
      </m.div>
