    ...
    >
      <m.div variants={varFade().inDown}>
        ...
        <Typography variant="body1" sx={{ fontSize: '1.2rem', color: 'text.secondary', mb: 3 }}>
          Tek School&apos;s <strong>[xth round of] [course title]</strong> starts on{' '}
          <strong>[date]</strong>! There is also the <strong>[course title]</strong> which will
          start on <strong>[date]</strong>. Admissions open!
        </Typography>
      </m.div>
