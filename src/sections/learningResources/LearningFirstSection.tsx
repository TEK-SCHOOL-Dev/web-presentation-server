    ...
    >
      <m.div variants={varFade().inDown}>
        ...
        <Typography variant="body1" sx={{ fontSize: '1.2rem', color: 'text.secondary', mb: 3 }}>
          Tek School offers a variety of resources that help you learn anywhere, anytime and at your
          own pace. Take advantage of our facilities to learn hone your skill set and stay
