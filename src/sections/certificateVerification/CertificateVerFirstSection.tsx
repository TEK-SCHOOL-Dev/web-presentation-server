    ...
    >
      <m.div variants={varFade().inDown}>
        ...
        <Typography variant="body1" sx={{ fontSize: '1.2rem', color: 'text.secondary', mb: 3 }}>
          We understand the importance of having credible certification, and help our students
          demonstrate their skills and knowledge to potential employers through practice and
          certification. Enter your name and certificate ID to verify the authenticity of
          certificates you have earned through Tek School.
        </Typography>
      </m.div>
