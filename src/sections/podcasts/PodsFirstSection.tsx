    ...
    >
      <m.div variants={varFade().inDown}>
        ...
        <Typography variant="body1" sx={{ fontSize: '1.2rem', color: 'text.secondary', mb: 3 }}>
          Welcome to TEKCast, the Tek School podcast where we discuss the latest trends in
          information technology, interview industry experts, and share insights that pave the way
