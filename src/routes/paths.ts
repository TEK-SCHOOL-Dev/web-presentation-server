...
const ROOT_ADMISSION = '/Admission';
// ----------------------------------------------------------------------

export const PATH_HOME = {
  root: ROOT_HOME,
  upcomingClasses: path(ROOT_HOME, 'upcoming-classes'),
  courseCatalog: path(ROOT_HOME, 'course-catalog'),
};
...
export const PATH_PAGE = {
  ...
  webinarsAndWorkShops: '/webinars-and-workshops',
  blogs: '/blogs',
  podcasts: '/podcasts',
  ...
  studentActivities: '/student-activities-and-events',
