...
import {
  ...
  TekAidPartners,
  InternationalStudnetsPage,
  FinancialAidRequirmentPage,
  WomenForAfghanWomenPage,
  AfghanAmericanOrganizationPage,
  AfghanAmericanFoundationPage,
  // Resources Pages
  ...
  return useRoutes([
    ...
    // Main Routes
    {
      ...
      children: [
        ...
        { path: 'compliance-testing', element: <ComplianceTestingPage /> },
        { path: 'automation', element: <AutomationPage /> },
        { path: 'security-testing', element: <SecurityTestingPage /> },
        { path: 'comptia', element: <ComptiaPage /> },
        { path: 'istqb', element: <IstqbPage /> },
        { path: 'oracle', element: <OraclePage /> },
        { path: 'scrum-alliance', element: <ScrumAlliancePage /> },
        { path: 'ica', element: <IcaPage /> },
        { path: 'iqi', element: <IsqiPage /> },
        { path: 'selenium', element: <Selenium /> },
        { path: 'asq', element: <AsqPage /> },
        ...
        { path: 'international-students', element: <InternationalStudnetsPage /> },
        { path: 'financial-aid-requirements', element: <FinancialAidRequirmentPage /> },
